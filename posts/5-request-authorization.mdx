---
title: "Authorizing Laravel's Custom Requests"
description: "In this article, we will explore how to authorize custom requests in Laravel. We'll explore different ways to do it, and we'll see how to use them the `authorize` method in custom form requests."
author: 'Èrik C. Forés'
date: 'Sep 10 2022'
tags:
  - 'PHP'
...
In this article, we will explore how to authorize custom requests in Laravel. We'll explore
...
when the request is being validated. It is used to authorize the request, and it is where the
...
authorized, and if it returns `false`, the request will be unauthorized.
...
The issue with those codes is that you're splitting your authorization logic between the policy
