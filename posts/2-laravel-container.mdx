---
title: "Understanding Laravel's Service Container and Dependency Injection"
description: "This article will explore what a service container is, and how dependency injection works in laravel."
author: "Èrik C. Forés"
date: "Dec 29 2021"
tags:
  - "PHP"
...
On its core, a Laravel application is a service container. Laravel does make heavy
...
That's why Laravel makes use of Dependency Injection, or DI for short. DI essentially uses PHP's [Reflection](https://www.php.net/manual/en/book.reflection.php)
...
There are a lot of places in Laravel where Laravel uses DI directly. Most notably, all controller methods are called
